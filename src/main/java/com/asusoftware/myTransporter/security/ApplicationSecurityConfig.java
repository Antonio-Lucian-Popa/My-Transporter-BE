...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .permitAll()
                .antMatchers(HttpMethod.DELETE, "/api/v1/user/delete/**")
                .permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/invitationLink/create/**")
                .permitAll()
                .antMatchers(HttpMethod.GET, "/api/v1/user/findAllTransporterFollowers/**")
                .permitAll()
                ...
                .permitAll()
                .antMatchers(HttpMethod.DELETE, "/api/v1/post/delete/**")
                .permitAll()
